...
function Header() {
  ...
  const openLinkInNewTab = () => {
    window.open("https://kao1587.github.io/home-cooking-202512", '_blank', 'noopener,noreferrer');
  }
      ...
      <header className='container normal'>
        ...
        <nav>
          <ul>
            ...
            <li><a href="https://kao1587.github.io/home-cooking-202512" target='_blank'><button className='contact-btn button' type='button'><img src={mailIcon} alt="mail icon" /><span className='tablet-invisible'>お問い合わせ</span></button></a></li>
          </ul>
        </nav>
